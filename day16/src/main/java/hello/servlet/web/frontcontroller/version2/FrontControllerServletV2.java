...
public class FrontControllerServletV2 extends HttpServlet {
    ...
    public FrontControllerServletV2(){
        controllerMap.put("/front-controller/v2/students/new-form", new StudentFormControllerV2());
        controllerMap.put("/front-controller/v2/students/save", new StudentSaveControllerV2());
        controllerMap.put("/front-controller/v2/students", new StudentListControllerV2());
    }
